 ...
 */
class InArray extends \Laminas\Validator\AbstractValidator
{
     ...
     *
     * @return mixed
     * @throws RuntimeException If haystack option is not set.
     */
    ...
    public function setStrict($strict)
    {
        ...
        if (! in_array($strict, $checkTypes)) {
            throw new InvalidArgumentException('Strict option must be one of the COMPARE_ constants');
        }
